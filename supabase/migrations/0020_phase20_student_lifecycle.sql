...
create index if not exists student_enrollments_academic_year_idx on public.student_enrollments(academic_year_id);
create index if not exists student_enrollments_section_idx on public.student_enrollments(section_id);
